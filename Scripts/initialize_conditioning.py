...
beach_con = ['/beach_' in i for i in stims_full_path]
camp_con = ['/camp_' in i for i in stims_full_path]
...
pd.DataFrame.to_csv(df_all_stims,os.path.join(exp_dir,'Protocol','conditioining_scenes.csv'))